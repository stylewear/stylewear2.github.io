...
<style>
  ...
  header {background:#222; color:#fff; text-align:center; padding:1rem; font-size:1.8rem; font-weight:bold; position:sticky; top:0; z-index:100;}
...
<div class="products">
  ...
  <div class="product-card" data-name="Casual Shirt" data-price="30" data-img="https://via.placeholder.com/200x200/ffbf7f" data-category="shirt">
    <img src="https://via.placeholder.com/200x200/ffbf7f" alt="Casual Shirt">
    <h3>Casual Shirt</h3>
    <p>Këmishë e rehatshme dhe moderne</p>
...
<script>
  ...
  function updateCart(){
    ...
    document.querySelectorAll('.plus').forEach(btn=>{
      btn.onclick=()=>{ const i=btn.dataset.index; cart[i].qty++; updateCart(); };
    });
    document.querySelectorAll('.minus').forEach(btn=>{
      btn.onclick=()=>{ const i=btn.dataset.index; if(cart[i].qty>1){cart[i].qty--; updateCart();} };
    });
  }
